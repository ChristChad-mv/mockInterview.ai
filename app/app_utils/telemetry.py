"""
MockInterview.ai Telemetry
Configures OpenTelemetry for tracking agent sessions, traces, and logging to GCP.
"""
...
def setup_telemetry() -> str | None:
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=mockinterview-agent,service.version={commit_sha}",
        )
